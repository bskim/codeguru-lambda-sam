...
//public class App extends RequestHandlerWithProfiling<Map<String,Object>, String> {
...
/*    @Override
    public String requestHandler(Map<String, Object> input, Context context) {
        // Your function code here
        GatewayResponse result = (GatewayResponse) this.myHandlerFunction(input, context);
        return String.format("status code:\"%d\", body:\"%s\"", result.getStatusCode(), result.getBody());
    }
*/
    public Object myHandlerFunction( Object input,  Context context) {
        ...
        try {
            ...
            String ddbtestput = this.PutItem("HelloWorldTable", "id", id.toString(), "field1", "stringValue1");
            String ddbtestget = this.GetItem("HelloWorldTable", "id", id.toString());

            String output = String.format(
                    "{ \"message\": \"hello world\", \"location\": \"%s\" \n \"put\":\"%s\"-\"%s\" \n \"get\":\"%s\"-\"%s\"}",
                    pageContents, id.toString(), ddbtestput, id.toString(), ddbtestget);
    ...
    private String GetItem(String TableName, String PrimaryKey, String Value) // throws
